...
tf.add_to_collection('W2',tf.trainable_variables()[2])
tf.add_to_collection('U2',tf.trainable_variables()[3])
tf.add_to_collection('W3',tf.trainable_variables()[4])
tf.add_to_collection('U3',tf.trainable_variables()[5])
tf.add_to_collection('W_conv1',tf.trainable_variables()[6])
tf.add_to_collection('b_conv1',tf.trainable_variables()[7])
