...
tf.add_to_collection('W1', W_conv1)
b_conv1=bias_variable([32])
tf.add_to_collection('b1', b_conv1)
...
tf.add_to_collection('W2', W_conv2)
tf.add_to_collection('b2', b_conv2)
...
for i in range(10000):
	...
	if(i%100==0):
		print("%d %f"%(i,accuracy.eval({x:batch[0],y_:batch[1],keep_prob:1.0})))
